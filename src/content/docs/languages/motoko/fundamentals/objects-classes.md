...
Motoko's light-weight [record](/languages/motoko/fundamentals/records) syntax makes it easy to construct such objects.
...
An object declaration just declares a single object. To declare a function that generates objects of a similar type, Motoko offer classes. A class acts as a blueprint for creating multiple objects with independent [state](/languages/motoko/fundamentals/state).
...
[Learn more about subtyping](/languages/motoko/fundamentals/subtyping).
