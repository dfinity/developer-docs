...
A switch is constructed from an expression and a sequence of cases. Each case consists of a [pattern](/languages/motoko/fundamentals/8-pattern-matching) guarding an expression or block that defines a possible branch of execution.
