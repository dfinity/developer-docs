...
All Motoko types are divided into sets. The smallest is the set of shared types. Shared types are part of the larger set of [stable types](/languages/motoko/fundamentals/stable-types).  
...
Most [primitive types](/languages/motoko/fundamentals/primitive-types) are shared by default.
...
Collections that cannot be modified after creation are shared, including [immutable arrays](/languages/motoko/fundamentals/immutable-arrays) and [tuples](/languages/motoko/fundamentals/tuples).
...
Objects with immutable fields containing shared types are shared, including [records](/languages/motoko/fundamentals/records).
...
[Variant types](/languages/motoko/fundamentals/variants) are shared when their tags contain shared types.
...
[Option types](/languages/motoko/fundamentals/options) are shared when they contain shared types.
...
References to [actors](/languages/motoko/fundamentals/actors-async) are shared, allowing [canisters](https://internetcomputer.org/docs/building-apps/essentials/canisters) to call each other.
...
[Function types](/languages/motoko/fundamentals/functions) marked as `shared` are sharable.
