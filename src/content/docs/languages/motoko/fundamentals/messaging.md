...
Only async contexts support [error handling](/languages/motoko/fundamentals/9-error-handling) with `try/catch` because messaging errors only occur asynchronously.
