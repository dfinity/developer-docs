...
In Motoko, a type can define a structured [record](/languages/motoko/fundamentals/records) with labeled fields. Each field has a specific type, and you can access them using dot notation. Records are useful for organizing related data clearly and safely.
...
- [`Record`](/languages/motoko/fundamentals/records)
- [`Variant`](/languages/motoko/fundamentals/variants)
