(function () {
  ...
  Object.assign(s.dataset, {
    ...
    modalExampleQuestions: 'What makes ICP different from traditional clouds?,How do I pay for my application?,Where does my app store data?,How do I add user login to my app?',
