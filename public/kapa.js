(function () {
  ...
  Object.assign(s.dataset, {
    ...
    modalExampleQuestions: 'What makes ICP different from traditional clouds?,How does my app store data?,How do I pay for my application?,How do I add user login to my app?',
