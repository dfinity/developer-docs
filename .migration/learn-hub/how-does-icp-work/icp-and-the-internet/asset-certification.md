---
learn_hub_id: 34276431179412
learn_hub_url: "https://learn.internetcomputer.org/hc/en-us/articles/34276431179412-Asset-Certification"
learn_hub_title: "Asset Certification"
...
When a canister issues a response along with its certificate, a [HTTP Gateway](https://internetcomputer.org/how-it-works/smart-contracts-serve-the-web) can be used to verify the certificate before passing on the response to the client.

For more information on certification, check [Certified Variables](https://internetcomputer.org/how-it-works/response-certification/).
