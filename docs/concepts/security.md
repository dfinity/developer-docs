...
See [Access management](../guides/security/identity-and-access-management.md#disallow-the-anonymous-principal-in-authenticated-calls) for implementation patterns.
