...
- For web assets (HTML, CSS, JavaScript, images), canisters can certify all assets upfront. The frontend canisters DFINITY provides handle this automatically: developers specify a folder of assets, and the canister manages and certifies them.
