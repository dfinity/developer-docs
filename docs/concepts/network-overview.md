...
The Internet Computer (ICP) is a network of independent blockchains called **subnets** that run [canisters](canisters.md) at web speed. From a developer's perspective, the key things to understand are how your code gets replicated, how fast it runs, and how requests reach it.
