...
> To grant or inspect an allowance manually without writing code, use the [`icp token approve`](https://cli.internetcomputer.org/1.5/reference/cli#icp-token-approve) and [`icp token allowance`](https://cli.internetcomputer.org/1.5/reference/cli#icp-token-allowance) CLI commands.
