...
See [Canister settings](settings.mdx) for all available settings and their syntax.
...
## Setting a freezing threshold programmatically
...
- **Review canister settings** — See [Canister settings](settings.mdx) for memory allocation, compute allocation, and access controls
...
- [Canister settings](settings.mdx) — Freezing threshold, memory allocation, compute allocation
- [Canister lifecycle](lifecycle.mdx) — Create, install, upgrade, and delete canisters
