...
> **Note:** Canisters are like real estate on the IC. Creating them costs cycles. Instead of deleting a canister, consider reusing it in a different project. Check the [cli reference](https://cli.internetcomputer.org/1.5/concepts/project-model/#canister-ids) for more information.
...
Canisters can manage other canisters by calling the [management canister](../../references/management-canister.md) (`aaaaa-aa`). This enables patterns like canister factories that create and manage child canisters dynamically.
...
{/* Source: dfinity/cdk-rs, ic-management-canister-types/src/lib.rs */}
