...
For what an organization publishes to make this flow work, see [Enterprise SSO](enterprise-sso.md).
...
- [Enterprise SSO](enterprise-sso.md) for connecting an organization's own OpenID provider, from the administrator's side
