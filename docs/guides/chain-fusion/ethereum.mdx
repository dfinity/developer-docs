...
// Type definitions omitted for brevity — see full example below

#[update]
async fn get_latest_block() -> Block {
    let cycles: u128 = 10_000_000_000;

    let (result,): (MultiResult<Block>,) =
...
use ic_cdk::api::management_canister::ecdsa::{
    ecdsa_public_key, EcdsaCurve, EcdsaKeyId,
...
async fn send_raw_transaction(
    ...
    let (result,): (MultiResult<SendRawTransactionStatus>,) =
...
{/* Upstream: informed by dfinity/portal — docs/building-apps/chain-fusion/ethereum/*; dfinity/icskills — skills/evm-rpc/SKILL.md */}
