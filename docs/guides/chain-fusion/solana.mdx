...
The SOL RPC canister (`2xib7-jqaaa-aaaar-qai6q-cai`) is deployed on ICP mainnet and handles Solana JSON-RPC calls on your behalf. For a flow diagram, see [Solana integration](../../concepts/chain-fusion/solana.md#sol-rpc-canister). When your canister calls it:
...
For a flow diagram, see [Solana integration](../../concepts/chain-fusion/solana.md#depositing-sol-sol-to-cksol).

### Withdrawal (ckSOL to SOL)

For a flow diagram, see [Solana integration](../../concepts/chain-fusion/solana.md#withdrawing-sol-cksol-to-sol).
...
- [Chain Fusion concepts](../../concepts/chain-fusion/index.md): how ICP connects to other blockchains
