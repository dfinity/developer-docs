...
note right of BTC: 6 confirmations required
...
3. Wait for 6 Bitcoin confirmations (mainnet). The minter will not process UTXOs until the required number of confirmations is reached.
