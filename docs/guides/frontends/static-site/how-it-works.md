...
**[HTTP gateway](../../../references/http-gateway-protocol-spec.md)**.
...
through an
[agent](../../canister-calls/calling-from-clients.md)
...
<!-- Generated by scripts/sync-static-site.mjs from dfinity/certified-assets docs/how-it-works.md at d9cb7df. Do not edit directly: the next sync overwrites it. Content changes belong upstream. -->
