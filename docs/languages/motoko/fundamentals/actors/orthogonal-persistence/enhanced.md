...
title: "Enhanced orthogonal persistence"
---
...
Any more complex change can be performed with programmatic instruction, see [explicit migration](/languages/motoko/fundamentals/actors/data-persistence#explicit-migration).
