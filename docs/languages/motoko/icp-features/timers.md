...
If the `timer` system method is declared, the [`Timer.mo`](https://mops.one/core/docs/Timer) core package module may not function correctly and should not be used.
