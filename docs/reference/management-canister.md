...
For the full formal specification, see the [IC interface specification](ic-interface-spec/index.md).
...
- [IC interface specification](ic-interface-spec/index.md): the complete formal specification
