...
For well-known ledger canister IDs and index canisters, see [Token ledgers](../../guides/defi/token-ledgers.md#well-known-token-ledgers). For a comprehensive list of all tokens on ICP, see the [ICP Dashboard token list](https://dashboard.internetcomputer.org/tokens).
