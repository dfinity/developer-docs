...
- **[Verifiable Credentials Specification](verifiable-credentials-spec.md)**: Normative protocol for issuing and verifying credentials on ICP: Issuer Candid API and Identity Provider window.postMessage interface.
