...
A typical project generated by `icp new my-project` looks like this:

```
my-project/
├── icp.yaml              # Project configuration (the project root)
├── .icp/                 # Generated files (canister IDs, build artifacts)
...
│       ├── src/
│       ├── dist/         # Built assets (uploaded to the asset canister)
│       └── package.json
