...
export const sidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      // Frontends lists its pages explicitly, unlike every other group here,
      // because the label of an autogenerated group is the directory name and
      // "static-site" is a recipe name rather than anything a reader is looking
      // for. The pages inside that group stay autogenerated, so a page added
      // upstream reaches the sidebar through the sync with no change here.
      {
        label: "Frontends",
        collapsed: true,
        items: [
          {
            label: "Hosting a static site",
            collapsed: true,
            items: [{ autogenerate: { directory: "guides/frontends/static-site", collapsed: true } }],
          },
          { slug: "guides/frontends/frameworks" },
          { slug: "guides/frontends/custom-domains" },
          { slug: "guides/frontends/certification" },
          { slug: "guides/frontends/service-discoverability" },
          { slug: "guides/frontends/asset-canister" },
        ],
      },
      {
